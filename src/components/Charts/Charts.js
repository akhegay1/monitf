...
function Charts() {
  ...
  let [vmetricsCherr, setVmetricsCherr] = useState("");
  ...
  const fetchVmetricsCh = async () => {
    ...
    let url = `${baseurl}vmetrics/getbydt`;
  ...
  let unique = vappcontext.vVmetricsCh
  ...
  if (typeof vmetricsCherr[0] != "undefined") {
    apivmetricserr = vmetricsCherr[0].err;
  }
